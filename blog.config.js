...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'CookieChoo', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'monash ee phd🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.cookiechoo.life', // 网站地址
